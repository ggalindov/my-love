...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(e,t,n){return new Ci({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ma,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Xa(),fragmentShader:`
	...
	`}var Za=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new li(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function zc(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(0),[i,a]=(0,_.useState)(0),o=(0,_.useRef)(null);(0,_.useEffect)(()=>{let e=Ic();if(!e)return;t(!e.paused),r(e.currentTime||0),a(e.duration||0);let n=()=>t(!0),i=()=>t(!1),o=()=>{r(e.currentTime||0),e.duration&&!isNaN(e.duration)&&a(e.duration)},s=()=>{e.duration&&a(e.duration)};return e.addEventListener(`play`,n),e.addEventListener(`pause`,i),e.addEventListener(`timeupdate`,o),e.addEventListener(`loadedmetadata`,s),()=>{e.removeEventListener(`play`,n),e.removeEventListener(`pause`,i),e.removeEventListener(`timeupdate`,o),e.removeEventListener(`loadedmetadata`,s)}},[]);let s=()=>{let e=Ic();e&&(e.paused?e.play().then(()=>{t(!0)}).catch(e=>{console.warn(`Error al reproducir audio:`,e)}):(e.pause(),t(!1)))},c=e=>{let t=Ic(),n=o.current;if(!t||!n||!t.duration)return;let i=n.getBoundingClientRect(),a=e.clientX-i.left;t.currentTime=Math.max(0,Math.min(1,a/i.width))*t.duration,r(t.currentTime)},l=i>0?n/i*100:0;return(0,b.jsxs)(`div`,{className:`lux-player-wrap`,children:[(0,b.jsx)(`style`,{children:Rc}),(0,b.jsxs)(`div`,{className:`lux-visualizer ${e?`playing`:``}`,children:[(0,b.jsx)(`div`,{className:`lux-bar lux-bar-1`}),(0,b.jsx)(`div`,{className:`lux-bar lux-bar-2`}),(0,b.jsx)(`div`,{className:`lux-bar lux-bar-3`}),(0,b.jsx)(`div`,{className:`lux-bar lux-bar-4`})]}),(0,b.jsxs)(`div`,{className:`lux-info`,children:[(0,b.jsx)(`div`,{className:`lux-title`,title:`Como un sello (Cantares 8:6-7)`,children:`Como un sello`}),(0,b.jsx)(`div`,{className:`lux-artist`,children:`Darviin 💕`})]}),(0,b.jsxs)(`div`,{className:`lux-scrubber-box`,children:[(0,b.jsx)(`span`,{className:`lux-time`,children:Lc(n)}),(0,b.jsx)(`div`,{className:`lux-track`,ref:o,onClick:c,title:`Haz clic para adelantar o retroceder`,children:(0,b.jsx)(`div`,{className:`lux-line`,children:(0,b.jsx)(`div`,{className:`lux-fill`,style:{width:`${l}%`}})})}),(0,b.jsx)(`span`,{className:`lux-time`,children:Lc(i||215)})]}),(0,b.jsx)(`button`,{className:`lux-btn`,onClick:s,"aria-label":e?`Pausar`:`Reproducir`,children:e?(0,b.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,b.jsx)(`path`,{d:`M6 19h4V5H6v14zm8-14v14h4V5h-4z`})}):(0,b.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`currentColor`,style:{marginLeft:`2px`},children:(0,b.jsx)(`path`,{d:`M8 5v14l11-7z`})})})]})}var Bc=2e4,Vc=`
...
`,Uc=`
  /* Barra de carga (timer) en el borde inferior de la pantalla */
  .fl-loadbar {
    position: absolute;
  ...
  .fl-loadfill {
    height: 100%;
    background: linear-gradient(90deg, #f48fb1, #f02d7d);
...
`;function Wc({onComplete:e,audioRef:t}){let n=(0,_.useRef)(null),[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(20);return(0,_.useEffect)(()=>{let t=n.current,r,a,s=!1,c=Date.now(),l=new Fc({canvas:t.querySelector(`canvas`),alpha:!0});l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(window.innerWidth,window.innerHeight);let u=new Ln,d=new Ln,f=new $i(-1,1,1,-1,0,1),p=new ga,m=[new Xt(window.innerWidth,window.innerHeight),new Xt(window.innerWidth,window.innerHeight)],h=new mi(2,2),g=new Fn(16777215),_=new Ci({uniforms:{u_ratio:{value:window.innerWidth/window.innerHeight},u_point:{value:new W(.65,.3)},u_time:{value:0},u_stop_time:{value:0},u_stop_randomizer:{value:new G(.5,1,1)},u_texture:{value:null},u_background_color:{value:g}},vertexShader:Hc,fragmentShader:Vc,transparent:!0}),v=new Ur({transparent:!0}),y=new Ur({color:g,transparent:!0});u.add(new ti(h,_)),d.add(new ti(h,y)),l.setRenderTarget(m[0]),l.render(d,f),d.children[0].material=v;let b={x:.65,y:.3,clicked:!0},x=!0;a=setInterval(()=>{b.x=.08+Math.random()*.84,b.y=.15+Math.random()*.7,b.clicked=!0},500+Math.random()*300);let S=()=>{_.uniforms.u_ratio.value=window.innerWidth/window.innerHeight,l.setSize(window.innerWidth,window.innerHeight),m.forEach(e=>e.setSize(window.innerWidth,window.innerHeight));let e=new Ln;e.add(new ti(h,y)),l.setRenderTarget(m[0]),l.render(e,f),l.setRenderTarget(null)};window.addEventListener(`resize`,S);function C(){r=requestAnimationFrame(C);let t=p.getDelta(),n=Date.now()-c;i(Math.min(n/Bc*100,100)),o(Math.max(0,Math.ceil((Bc-n)/1e3))),n>=Bc&&!s&&(s=!0,e()),_.uniforms.u_texture.value=m[0].texture,_.uniforms.u_time.value=p.getElapsedTime()+.9,b.clicked&&=(_.uniforms.u_point.value=new W(b.x,1-b.y),_.uniforms.u_stop_randomizer.value=x?new G(.5,1,1):new G(Math.random(),Math.random(),Math.random()),x=!1,_.uniforms.u_stop_time.value=0,!1),_.uniforms.u_stop_time.value+=t,l.setRenderTarget(m[1]),l.render(u,f),v.map=m[1].texture,l.setRenderTarget(null),l.render(d,f);let a=m[0];m[0]=m[1],m[1]=a}return C(),()=>{cancelAnimationFrame(r),clearInterval(a),window.removeEventListener(`resize`,S),l.dispose(),m.forEach(e=>e.dispose())}},[e]),(0,b.jsxs)(`div`,{ref:n,style:{position:`absolute`,inset:0,background:`#fff`},children:[(0,b.jsx)(`style`,{children:Uc}),(0,b.jsx)(`canvas`,{style:{display:`block`,width:`100%`,height:`100%`}}),(0,b.jsx)(`div`,{className:`fl-label`,children:(0,b.jsx)(`span`,{children:`Preparando algo especial para ti... 💕`})}),(0,b.jsx)(`div`,{style:{position:`absolute`,bottom:`clamp(18px, 4vh, 26px)`,left:`50%`,transform:`translateX(-50%)`,zIndex:25,width:`calc(100% - 24px)`,maxWidth:`400px`,display:`flex`,justifyContent:`center`,boxSizing:`border-box`,pointerEvents:`auto`},children:(0,b.jsx)(zc,{})}),(0,b.jsx)(`div`,{className:`fl-loadbar`,children:(0,b.jsx)(`div`,{className:`fl-loadfill`,style:{width:`${r}%`}})}),(0,b.jsx)(`div`,{className:`fl-timer`,children:a>0?`${a}s`:``})]})}var Gc=`
...
`,Kc=[3,5,7,11,13,17],qc={3:{colors:[`#f4a8b5`,`#d97d8f`],size:24,petals:5,type:`type1`,center:{color:`#fef08a`,size:8}},5:{colors:[`#fde047`,`#facc15`],size:23,petals:6,type:`type2`,center:{color:`#e899a8`,size:7}},7:{colors:[`#e899a8`,`#c56b7c`],size:28,petals:8,type:`type1`,center:{color:`#fef9c3`,size:9}},11:{colors:[`#fef08a`,`#eab308`],size:26,petals:5,type:`type3`,center:{color:`#c56b7c`,size:8}},13:{colors:[`#dba39a`,`#b76e79`],size:21,petals:7,type:`type4`,center:{color:`#fef08a`,size:6}},17:{colors:[`#fef9c3`,`#fde047`],size:29,petals:6,type:`type5`,center:{color:`#d97d8f`,size:10}}},Jc=[{radius:`0 100% 50% 50%`,gradient:`linear-gradient(135deg,#3a8029,#5cad4a)`,veinCount:3,veinAngle:-5},{radius:`0 70% 0 50%`,gradient:`linear-gradient(135deg,#4a9e35,#65c143)`,veinCount:5,veinAngle:-15},{radius:`50% 100% 50% 30%`,gradient:`linear-gradient(135deg,#2e5d20,#4a9e35)`,veinCount:4,veinAngle:0},{radius:`10% 90% 20% 80%`,gradient:`linear-gradient(135deg,#3a8029,#65c143)`,veinCount:6,veinAngle:-10},{radius:`50% 50% 0 50%`,gradient:`linear-gradient(135deg,#3d8c29,#5cad4a)`,veinCount:4,veinAngle:-8}],Yc=(e,t,n)=>Math.min(Math.max(e,t),n);function Xc(e,t){let n=parseInt(e.slice(1,3),16),r=parseInt(e.slice(3,5),16),i=parseInt(e.slice(5,7),16);return`rgb(${Yc(n+t*2,0,255)},${Yc(r+t*2,0,255)},${Yc(i+t*2,0,255)})`}function Zc(e){let t=e.querySelector(`.stars`),n=e.querySelector(`.clouds`),r=e.querySelector(`.garden`),i=e.querySelector(`.fireflies`);for(let e=0;e<200;e++){let e=document.createElement(`div`);e.classList.add(`star`);let n=Math.random()*2+1;e.style.cssText=`width:${n}px;height:${n}px;left:${Math.random()*100}%;top:${Math.random()*100}%;`;let r=3+Math.random()*7,i=Math.random()*5,a=Math.random()*.3,o=a+.4;e.style.setProperty(`--twinkle-duration`,`${r}s`),e.style.setProperty(`--twinkle-delay`,`${i}s`),e.style.setProperty(`--min-opacity`,a),e.style.setProperty(`--max-opacity`,o),t.appendChild(e)}for(let e=0;e<8;e++){let e=document.createElement(`div`);e.classList.add(`cloud`);let t=100+Math.random()*200,r=50+Math.random()*40;e.style.cssText=`width:${t}px;height:${r}px;left:${Math.random()*100}%;top:${Math.random()*50}%;opacity:${.1+Math.random()*.3};`;let i=100+Math.random()*100,a=100+Math.random()*100;e.style.setProperty(`--drift-distance`,`${i}vw`),e.style.animation=`cloudDrift ${a}s linear infinite`,n.appendChild(e)}function a(e,t,n,i,a,o){let s=document.createElement(`div`);s.classList.add(`flower`);let c=5+Math.random()*90,l=n+Math.random()*(i-n),u=a+Math.random()*(o-a);s.style.bottom=`${u}%`,s.style.left=`${c}%`;let d=.7+l*.6;s.style.setProperty(`--scale`,d),s.style.opacity=.9+l*.1,s.style.zIndex=Math.round(10+l*90);let f=qc[t||Kc[Math.floor(Math.random()*Kc.length)]],p=(30+Math.random()*50)*(.8+l*.4),m=document.createElement(`div`);m.classList.add(`stem`),m.style.height=`0px`,m.dataset.fullHeight=`${p}px`,m.style.background=`linear-gradient(to top,rgba(30,20,10,.9) 0%,#2e5d20 5%,#5cad4a 50%,#2e5d20 95%)`;let h=8+Math.random()*5,g=Math.random()*4;if(Math.random()>.3){m.classList.add(`curved`);let e=Math.random()*1.5+1.5;m.style.setProperty(`--bend-rotation-neg`,`-${e}deg`),m.style.setProperty(`--bend-rotation-pos`,`${e}deg`),m.style.transformOrigin=`center ${Math.random()*20+40}%`,m.style.animation=`stemBend ${h*1.2}s ease-in-out infinite`,m.style.animationDelay=`${g}s`}s.style.animation=`sway ${h}s ease-in-out infinite`,s.style.animationDelay=`${g}s`;let _=f.petals,v=f.size/2,y=f.center.size,b=document.createElement(`div`);b.classList.add(`center`),b.style.backgroundColor=f.center.color,b.style.boxShadow=`0 0 8px ${f.center.color}`,b.style.width=`${y}px`,b.style.height=`${y}px`,b.style.bottom=`0px`,b.style.left=`${-y/2}px`;for(let e=0;e<_;e++){let t=document.createElement(`div`);t.classList.add(`petal`,f.type);let n=Math.floor(Math.random()*8)-4;t.style.background=`linear-gradient(to bottom,${Xc(f.colors[0],n)},${Xc(f.colors[1],n)})`;let r=.9+Math.random()*.2;t.style.width=`${v*r}px`,t.style.height=`${v*1.2*r}px`;let i=360/_*e+(Math.random()*5-2.5);t.style.bottom=`0px`,t.style.left=`${-v/2*r}px`,t.style.transformOrigin=`center bottom`,t.dataset.angle=i,s.appendChild(t)}let x=2+Math.floor(Math.random()*2);for(let e=0;e<x;e++){let t=document.createElement(`div`);t.classList.add(`leaf`);let n=.1+.8/x*e+Math.random()*.05,r=e%2==0?-1:1,i=Jc[Math.floor(Math.random()*Jc.length)],a=12+Math.random()*8,o=a*(.8+Math.random()*.4);t.style.width=`${o}px`,t.style.height=`${a/2}px`,t.style.bottom=`${p*n}px`,t.style.left=`0px`;let s=r*(25+Math.random()*20);t.style.setProperty(`--leaf-angle`,`${s}deg`),t.style.setProperty(`--leaf-sway`,`${Math.random()*5+3}deg`);let c=document.createElement(`div`);c.classList.add(`leaf-shape`),c.style.borderRadius=i.radius,c.style.background=i.gradient,r>0&&(c.style.transform=`scaleX(-1)`);let l=document.createElement(`div`);l.classList.add(`leaf-stem`),l.style.background=i.gradient.split(`,`)[0].replace(`linear-gradient(135deg`,``).trim(),l.style.left=`-4px`;let u=document.createElement(`div`);u.classList.add(`main-vein`),u.style.background=`rgba(25,50,15,.3)`,u.style.transform=`translateY(-50%) rotate(${i.veinAngle}deg)`,c.appendChild(u);for(let e=1;e<=i.veinCount;e++){let t=document.createElement(`div`);t.classList.add(`side-vein`),t.style.background=`rgba(25,50,15,.2)`,t.style.top=`${e*100/(i.veinCount+1)}%`,t.style.transform=`translateY(-50%) rotate(${-20+e*5+(Math.random()*5-2.5)}deg)`,t.style.width=`${60+Math.random()*20}%`,c.appendChild(t)}t.appendChild(l),t.appendChild(c),m.appendChild(t)}s.appendChild(m),s.appendChild(b),r.appendChild(s);let S=e<500;setTimeout(()=>{m.style.height=m.dataset.fullHeight,setTimeout(()=>{b.style.bottom=m.dataset.fullHeight;let e=s.querySelectorAll(`.petal`);e.forEach(e=>{e.style.bottom=m.dataset.fullHeight;let t=parseFloat(e.dataset.angle),n=t*Math.PI/180,r=y*.5*Math.sin(n),i=y*.5*Math.cos(n);e.style.transform=`rotate(${t}deg) translate(${r}px,${-i}px) scale(0)`}),b.style.opacity=`1`,b.style.transform=`scale(1)`;let t=S?10:80;e.forEach((e,n)=>setTimeout(()=>{e.style.opacity=`1`;let t=parseFloat(e.dataset.angle),n=t*Math.PI/180,r=y*.5*Math.sin(n),i=y*.5*Math.cos(n);e.style.transform=`rotate(${t}deg) translate(${r}px,${-i}px) scale(1)`},n*t+(S?0:Math.random()*40)));let n=m.querySelectorAll(`.leaf`),r=S?10:100;n.forEach((e,t)=>setTimeout(()=>{e.style.opacity=`1`,e.style.transform=`rotate(${e.style.getPropertyValue(`--leaf-angle`)})`,e.style.animation=`leafSway ${3+Math.random()*2}s ease-in-out infinite`},t*r+(S?0:Math.random()*50)))},S?50:800)},S?10:e);let C=r.querySelectorAll(`.flower`);if(C.length>220){let e=C[0];e.style.animation=`fadeOut 2s forwards`,setTimeout(()=>e.remove(),2e3)}}for(let e=0;e<70;e++){let t=Math.random();t<.3?a(e*35,null,.8,1,10,40):t<.6?a(e*35,null,.5,.7,25,45):t<.85?a(e*35,null,.3,.5,35,45):a(e*35,null,.1,.3,42,46)}let o=setInterval(()=>{let e=Math.random(),t=Kc[Math.floor(Math.random()*Kc.length)];e<.3?a(0,t,.8,1,10,40):e<.6?a(0,t,.5,.7,25,45):e<.85?a(0,t,.3,.5,35,45):a(0,t,.1,.3,42,46)},450);return setTimeout(()=>{let t=e.querySelector(`.ground`);if(!t)return;let n=window.innerHeight-t.offsetHeight;for(let e=0;e<10;e++){let t=document.createElement(`div`);t.classList.add(`firefly`);let r=Math.random()*100,a=n/window.innerHeight*100,o=10+Math.random()*(a-10-15);for(let e=1;e<=9;e++)t.style.setProperty(`--x${e}`,`${Math.random()*6-3}px`),t.style.setProperty(`--y${e}`,`${Math.random()*5-4}px`);t.style.left=`${r}%`,t.style.top=`${o}%`,i.appendChild(t),setTimeout(()=>{t.style.opacity=`1`,t.style.animation=`fireflyFloat ${3+Math.random()*3}s ease-in-out infinite`;let e=Kc[Math.floor(Math.random()*Kc.length)];setInterval(()=>{t.style.opacity!==`0`&&(t.style.opacity=`0`,setTimeout(()=>{t.style.opacity=`1`,Math.random()>.7&&setTimeout(()=>{t.style.opacity=`0`,setTimeout(()=>{t.style.opacity=`1`},100)},200)},100+Math.random()*200))},e*1e3+Math.random()*3e3),setInterval(()=>{if(Math.random()>.7){let e=Yc(parseFloat(t.style.left)+Math.random()*15-15/2,0,100),n=Yc(parseFloat(t.style.top)+Math.random()*15-15/2,10,a-15);t.style.transition=`left 2.5s ease-in-out,top 2.5s ease-in-out`,t.style.left=`${e}%`,t.style.top=`${n}%`,setTimeout(()=>{t.style.transition=`opacity .5s ease`},2500)}},e*1e3+Math.random()*5e3)},e*200+Math.random()*1e3)}},500),()=>{clearInterval(o)}}function Qc({onComplete:e}){let t=(0,_.useRef)(null),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)([]);(0,_.useEffect)(()=>{if(t.current)return Zc(t.current)},[]);let u=(0,_.useCallback)(()=>{n||(r(!0),setTimeout(()=>{a(!0)},600),setTimeout(()=>{s(!0)},1800),setTimeout(()=>{l([{id:0,icon:`✨`,left:`46%`,top:`36%`,delay:`0s`},{id:1,icon:`💕`,left:`52%`,top:`34%`,delay:`.3s`},{id:2,icon:`⭐`,left:`42%`,top:`32%`,delay:`.6s`},{id:3,icon:`🌸`,left:`54%`,top:`35%`,delay:`.9s`}])},1400),setTimeout(()=>{e()},3200))},[n,e]);return(0,b.jsxs)(`div`,{className:`garden-root`,children:[(0,b.jsx)(`style`,{children:Gc}),(0,b.jsxs)(`div`,{className:`garden-container`,ref:t,children:[(0,b.jsx)(`div`,{className:`night-sky`}),(0,b.jsx)(`div`,{className:`stars`}),(0,b.jsx)(`div`,{className:`clouds`}),(0,b.jsx)(`div`,{className:`ground`}),(0,b.jsx)(`div`,{className:`garden`}),(0,b.jsx)(`div`,{className:`fireflies`})]}),(0,b.jsxs)(`div`,{className:`star-btn-wrap`,onClick:u,children:[(0,b.jsx)(`span`,{className:`star-hint`,children:`Toca nuestra estrella... ✨`}),(0,b.jsx)(`button`,{className:`star-btn`,"aria-label":`Abrir carta de amor`,children:(0,b.jsxs)(`svg`,{className:`star-svg`,viewBox:`0 0 100 100`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,b.jsx)(`circle`,{cx:`50`,cy:`50`,r:`30`,fill:`url(#starGlowGrad)`,opacity:`0.85`}),(0,b.jsx)(`path`,{d:`M50 0 L55 38 L95 50 L55 62 L50 100 L45 62 L5 50 L45 38 Z`,fill:`#fff9db`}),(0,b.jsx)(`path`,{d:`M50 14 L53 43 L82 50 L53 57 L50 86 L47 57 L18 50 L47 43 Z`,fill:`#ffffff`}),(0,b.jsx)(`path`,{d:`M26 26 L44 44 M74 26 L56 44 M74 74 L56 56 M26 74 L44 56`,stroke:`#ffe066`,strokeWidth:`3`,strokeLinecap:`round`}),(0,b.jsx)(`circle`,{cx:`50`,cy:`50`,r:`7`,fill:`#ffffff`}),(0,b.jsx)(`defs`,{children:(0,b.jsxs)(`radialGradient`,{id:`starGlowGrad`,cx:`50%`,cy:`50%`,r:`50%`,children:[(0,b.jsx)(`stop`,{offset:`0%`,stopColor:`#fff2a8`,stopOpacity:`1`}),(0,b.jsx)(`stop`,{offset:`55%`,stopColor:`#ffd166`,stopOpacity:`0.6`}),(0,b.jsx)(`stop`,{offset:`100%`,stopColor:`#ffd166`,stopOpacity:`0`})]})})]})})]}),(0,b.jsxs)(`div`,{className:`envelope-overlay ${n?`active`:``}`,children:[(0,b.jsxs)(`div`,{className:`env-scene`,children:[(0,b.jsxs)(`div`,{className:`env-letter ${o?`risen`:``}`,children:[(0,b.jsx)(`strong`,{style:{color:`#c25774`,fontFamily:`'Dancing Script', cursive`,fontSize:`16px`},children:`💕 Mi Amor 💕`}),(0,b.jsx)(`br`,{}),`Para la mujer que ilumina`,(0,b.jsx)(`br`,{}),`mi vida entera...`]}),(0,b.jsx)(`div`,{className:`env-body`}),(0,b.jsx)(`div`,{className:`env-bottom`}),(0,b.jsx)(`div`,{className:`env-left`}),(0,b.jsx)(`div`,{className:`env-right`}),(0,b.jsx)(`div`,{className:`env-flap ${i?`open`:``}`})]}),c.map(e=>(0,b.jsx)(`div`,{className:`env-heart`,style:{left:e.left,top:e.top,animationDelay:e.delay},children:e.icon},e.id))]})]})}var $c=`Nunca olvides que eres mi regalo de Dios y tenerte en mi vida es de las más grandes bendiciones, chaolín plín plín 💕`,el=`
...
`;function tl(){let[e,t]=(0,_.useState)(`open`),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(!1),o=(0,_.useRef)(0),s=(0,_.useRef)(!1),c=e=>{e&&(e.preventDefault(),e.stopPropagation()),!s.current&&(s.current=!0,t(`closing`),setTimeout(()=>{t(`final`),r(``),a(!1),o.current=0},800))};return(0,_.useEffect)(()=>{if(e!==`final`)return;let t,n=()=>{if(o.current<117){let e=$c[o.current];o.current+=1,r($c.slice(0,o.current));let i=40;e===`,`?i=260:e===`.`&&(i=400),t=setTimeout(n,i)}else a(!0)};return t=setTimeout(n,400),()=>clearTimeout(t)},[e]),(0,b.jsxs)(`div`,{className:`ll-body`,children:[(0,b.jsx)(`style`,{children:el}),e!==`final`&&(0,b.jsxs)(`div`,{className:`ll-card ${e===`closing`?`closing`:``}`,children:[(0,b.jsxs)(`p`,{className:`ll-main`,children:[`Le pido a Dios día a día que me dé más sabiduría para aprender a amarte de la manera correcta.`,(0,b.jsx)(`br`,{}),(0,b.jsx)(`br`,{}),`No quiero únicamente amarte, sino que cada día pueda entenderte más, cuidarte, conocerte y jamás hacerte dudar de cuánto te amo.`]}),(0,b.jsxs)(`span`,{className:`ll-verse`,children:[`«Las muchas aguas no podrán apagar el amor que siento por ti, ni lo ahogarán los ríos»`,(0,b.jsx)(`br`,{}),(0,b.jsx)(`strong`,{children:`— Cantares 8:7`})]}),(0,b.jsxs)(`span`,{className:`ll-closing`,children:[`Te amo.`,(0,b.jsx)(`br`,{}),`Eternamente, Juan David 💕`]}),(0,b.jsx)(`div`,{className:`ll-action`,children:(0,b.jsx)(`button`,{type:`button`,className:`ll-close-btn`,onClick:c,onTouchEnd:c,"aria-label":`Cerrar carta`,children:`Cerrar carta 💌`})})]}),e===`final`&&(0,b.jsx)(`div`,{className:`ll-final-wrap`,onClick:()=>{e===`final`&&!i&&(o.current=117,r($c),a(!0))},children:(0,b.jsxs)(`div`,{className:`ll-final-box`,children:[(0,b.jsx)(`div`,{className:`ll-final-icon`,children:`✨ 🧸 💕`}),(0,b.jsxs)(`p`,{className:`ll-final-text`,children:[n,(0,b.jsx)(`span`,{className:`ll-final-cursor ${i?`hidden`:``}`})]}),i&&(0,b.jsx)(`div`,{className:`ll-reopen-wrap`,children:(0,b.jsx)(`button`,{type:`button`,className:`ll-reopen-btn`,onClick:e=>{e&&(e.preventDefault(),e.stopPropagation()),s.current=!1,t(`open`)},children:`Reabrir carta 💌`})})]})})]})}function nl(){let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)(!1),i=()=>{r(!0),setTimeout(()=>{t(e=>e+1),r(!1)},600)};return(0,b.jsxs)(`div`,{style:{width:`100%`,height:`100%`,position:`relative`,opacity:+!n,transition:`opacity 0.6s ease`},children:[e===0&&(0,b.jsx)(C,{onComplete:i}),e===1&&(0,b.jsx)(Wc,{onComplete:i}),e===2&&(0,b.jsx)(Qc,{onComplete:i}),e===3&&(0,b.jsx)(tl,{})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(nl,{})}));